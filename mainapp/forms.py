...
class UserAdd_WorkExperienceForm(forms.ModelForm):
    image=forms.ImageField()
    class Meta:
        model=WorkExperience
        fields=["image","title","profession","country","email","phone","skills1","percent","skills2","percent1","skills3","percent2",
                "lang","ken","lang2","ken2","lang3","ken3","work1","created1","work2","created2","work3","created3","Education1","created4","Education2","created5"]
